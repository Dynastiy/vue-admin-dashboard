                ...
                <div class="navbar-header">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-none d-lg-inline-block ml-1">
                            <button type="button" @click="darkThemeSwitch" class="btn header-item noti-icon waves-effect">
                                <i class="uil-toggle-on switch-text"></i>Light/Dark Mode
                            </button>
                        </div>
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="@/assets/img/users/avatar-4.jpg"
                                    alt="Header Avatar">
