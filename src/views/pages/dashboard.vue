                                        ...
                                        <div class="float-right">
                                            <div class="dropdown">
                                                <a class="dropdown-toggle text-reset" href="#" id="dropdownMenuButton5"
                                                    ...
                                                    aria-expanded="false">
                                                    <span class="font-weight-semibold">Sort By:</span> <span class="text-muted">Yearly</span>
                                                </a>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center no-gutters mt-3">
                                            <div class="col-sm-4">
                                                <p class="text-truncate mt-1 mb-0"><i class="mdi mdi-circle-medium text-primary mr-2"></i> Videos </p>
                                            </div>
                                        ...
                                        <div class="row align-items-center no-gutters mt-3">
                                            <div class="col-sm-4">
                                                <p class="text-truncate mt-1 mb-0"><i class="mdi mdi-circle-medium text-purple mr-2"></i>E-Books </p>
                                            </div>
                                            <div class="col-sm-8">
                                                <div class="progress mt-1" style="height: 6px;">
...
<script>
import breadcrumb from '../static/breadcrumb.vue';
import topnav from '../static/nav'
import sidenav from '../static/sidebar'
...
export default {
    ...
    // this.dashboard = await AuthService.getDashboard();
    // }
